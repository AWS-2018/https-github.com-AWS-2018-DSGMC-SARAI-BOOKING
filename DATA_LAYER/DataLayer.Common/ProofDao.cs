...
namespace DataLayer.Common
{
    public class ProofDao
    {
        ...
        /// <returns></returns>
        public List<Proof> GetList(string name)
        {
            List<Proof> lstData = new List<Proof>();
            ...
            lstData = Db.DapperGetList<Proof>(strQuery, new { name = "%" + name + "%" });
        ...
        /// <returns></returns>
        public List<Proof> GetList(int page, int pageSize)
        {
            List<Proof> lstData = new List<Proof>();
            ...
            lstData = Db.DapperGetList<Proof>(strQuery);
